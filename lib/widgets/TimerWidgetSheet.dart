...
class TimerWidgetSheet extends StatelessWidget {
              ...
              child: Column(
                ...
                children: <Widget>[
                  if (controller.timers.isNotEmpty) ...[
                    ...
                    // Month, date and time
                    Text(
                      "Next execution will start at ${DateFormat('MMMM d, HH:mm').format(findNextStartDate(controller.timers)!)}",
                    ),
                  ...
                  if (controller.timers.isNotEmpty) ...[
                    ...
                    PlatformElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.of(context).pop(controller.timers);
                      },
                    ),
                  ]
                ],
